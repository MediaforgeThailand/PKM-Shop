...
const stalePatterns = [
  [/15 edge\/shared\/storage\/template files scanned/i, 'edge-security audit now scans 16 edge/shared/storage/template files'],
  [/14 edge\/shared\/storage\/template files scanned/i, 'edge-security audit now scans 16 edge/shared/storage/template files'],
  [/13 edge\/shared\/template files scanned/i, 'edge-security audit now scans 16 edge/shared/storage/template files'],
  [/13 edge\/shared files scanned/i, 'edge-security audit now scans 16 edge/shared/storage/template files'],
  [/13 files scanned/i, 'edge-security audit now scans 16 files'],
  [/12 edge\/shared files scanned/i, 'edge-security audit now scans 16 edge/shared/storage/template files'],
  [/12 files scanned/i, 'edge-security audit now scans 16 files'],
