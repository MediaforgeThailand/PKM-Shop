...
const styles = StyleSheet.create({
  ...
  avatarText: {
    color: MiraDesign.color.showcaseSurface,
    fontSize: 18,
    fontWeight: '900',
  },
  lineTitle: {
  ...
  qrCell: {
    ...
    borderColor: MiraDesign.color.showcaseSurface,
    borderWidth: 1,
    height: 23,
    width: 23,
  },
  qrCellDark: {
    backgroundColor: MiraDesign.color.showcaseNavy,
  },
  qrText: {
    color: MiraDesign.color.showcaseNavySoft,
    fontSize: 12,
  ...
  statusBubble: {
    backgroundColor: MiraDesign.color.showcaseSurface,
    borderLeftColor: MiraDesign.color.showcaseBlue,
    borderLeftWidth: 4,
    borderRadius: MiraDesign.radius.sm,
    gap: 4,
    padding: MiraDesign.space.md,
