        ...
        {isDemoMode ? (
          <View style={styles.notice}>
            ...
            <Text style={styles.noticeBody}>
              {demoFallbackReason
                ? `กำลังแสดงข้อมูลตัวอย่าง เพราะ ${demoFallbackReason} ปุ่มบันทึก อัปโหลด และ archive จะถูกปิดไว้`
                : 'เปิดดู catalog ได้ทันทีโดยไม่ต้องล็อกอิน ปุ่มบันทึก อัปโหลด และ archive จะถูกปิดไว้'}
            </Text>
          </View>
        ) : null}
