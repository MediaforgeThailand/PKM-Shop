...
export const showcaseEntries: readonly ShowcaseEntry[] = [
  ...
  },
  {
    auth: 'none',
    demoOrder: 0,
    description_th: 'หน้าเข้าสู่ระบบสำหรับทีมงาน Admin Panel ตรวจสิทธิ์จาก tenant_members ก่อนเข้าข้อมูลจริง.',
    href: { pathname: '/login', params: { mode: 'admin', redirect: '/admin-panel' } },
    id: 'admin-login',
    label_en: 'Admin Login',
    label_th: 'เข้าสู่ระบบทีมงาน',
    module: 'admin',
    path: '/login',
    poster: null,
    status: 'live',
  },
  {
    auth: 'none',
    demoOrder: 0,
    description_th: 'หน้าเข้าสู่ระบบสำหรับกลุ่ม Referral ใช้ ref code ที่ admin สร้างให้เพื่อ claim โปรไฟล์ผู้แนะนำ.',
    href: { pathname: '/login', params: { mode: 'referral', redirect: '/partner' } },
    id: 'referral-login',
    label_en: 'Referral Login',
    label_th: 'เข้าสู่ระบบ Referral',
    module: 'referral',
    path: '/login',
    poster: null,
    status: 'live',
  ...
  },
  {
    auth: 'none',
    demoOrder: 1,
    description_th: 'หน้าเข้าสู่ระบบบัญชีลูกค้า Chat AI สำหรับเก็บประวัติแชต ออเดอร์ และข้อมูลสุขภาพของตัวเอง.',
    href: { pathname: '/login', params: { mode: 'chat', redirect: '/prototype' } },
    id: 'ai-chat-login',
    label_en: 'Chat AI Login',
    label_th: 'เข้าสู่ระบบลูกค้า',
    module: 'ai-chat',
    path: '/login',
    poster: null,
    status: 'live',
